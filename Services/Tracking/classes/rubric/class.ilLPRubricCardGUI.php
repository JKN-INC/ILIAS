    ...
    private function buildTemplateBehavior($behavior, $group_increment, $criteria_increment, $behavior_increment)
    {
        ...
        $tmp_write = "<td scope=\"rowgroup\">
                    <div class=\"form-group has-success has-feedback\">
                        ...
                        <textarea id=\"${tmp_behavior_name}\" {RUBRIC_DISABLED} name=\"${tmp_behavior_name}\" class=\"form-control textarea_other\" placeholder=\"${behavior['description']}\" value=\"${behavior['description']}\" aria-describedby=\"${tmp_behavior_name}WarningStatus\" onkeyup=\"validate(this)\" oninput=\"validate(this)\">${behavior['description']}</textarea>
