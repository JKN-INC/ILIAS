...
class ilLPRubricGradeGUI extends ilLPTableBaseGUI
{
    ...
    public function getRubricComment()
    {
        return $this->rubric_comment;
    }


    public function setRubricComment($rubric_comment)
    {
        $this->rubric_comment = $rubric_comment;
    }
    ...
    private function buildGradeCriteria($group,$criteria,$group_increment,$criteria_increment)
    {
        ...
        if($this->student_view || $this->pdf_view ){
            ...
            $tmp_write.="<td class=\"grade-point\" scope=\"rowgroup\">
                        ...
                        <tr>
                            <td class='td_comment'  style ='padding-left:30px;' colspan=\"$colspan\"><p>".nl2br($tmp_comment)."</p></td>
                        </tr>";
        }else{
            ...
            $tmp_write.="<td scope=\"rowgroup\">
                        ...
                        <tr>
                           <td class='td_comment' style ='padding-left:30px;' colspan=\"$colspan\">  <textarea name=\"$tmp_comment_name\"  $disabled value=\"$tmp_comment\" class=\"form-control textarea_grade_comment\" placeholder=\"{COMMENT}\">$tmp_comment</textarea></td>
                        </tr>";
        }
    ...
    private function buildGradeGroup($group,$group_increment)
    {
        ...
        $tmp_row_span=count($group['criteria'])*2;
    ...
    private function buildGradeTemplate()
    {
        ...
        $write="<div id=\"jkn_div_rubric\" class=\"table-responsive\">
            ...
            "<tfoot>
                            ...
                            <td colspan=\"$comment_colspan\">
                            ";

        if($this->student_view || $this->pdf_view ){
           $write.="<p class='comment_placeholder_p' disabled>".nl2br($this->rubric_comment)."</p>";
        }else{
           $write .=  "<textarea class='general_comment_placeholder' $history_disabled id=\"comment\" name=\"comment\" placeholder=\"General Comments\" >".$this->rubric_comment."</textarea>";
        }
        $write .="  </td>
